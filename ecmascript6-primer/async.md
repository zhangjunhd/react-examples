...
- [Generator函数](#generator函数)
  ...
  - [Generator函数的数据交换和错误处理](#generator函数的数据交换和错误处理)
  - [异步任务的封装](#异步任务的封装)
- [Thunk函数](#thunk函数)
  - [参数的求值策略](#参数的求值策略)
  - [Thunk函数的含义](#thunk函数的含义)
  - [JavaScript语言的Thunk函数](#javascript语言的thunk函数)
  - [Thunkify模块](#thunkify模块)
  - [Generator函数的流程管理](#generator函数的流程管理)
  - [Thunk函数的自动流程管理](#thunk函数的自动流程管理)
- [co模块](#co模块)
  - [基本用法](#基本用法)
  - [co模块的原理](#co模块的原理)
  - [基于Promise对象的自动执行](#基于promise对象的自动执行)
  - [co模块的源码](#co模块的源码)
  - [处理并发的异步操作](#处理并发的异步操作)
- [async函数](#async函数)
  - [含义](#含义)
  - [async函数的实现](#async函数的实现)
  - [async函数的用法](#async函数的用法)
  - [注意点](#注意点)
  - [与Promise、Generator的比较](#与promisegenerator的比较)
...
## co模块
### 基本用法
[co模块][1]是著名程序员TJ Holowaychuk于2013年6月发布的一个小工具，用于Generator函数的自动执行。
