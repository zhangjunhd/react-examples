...
已经有[提议][1]将这个需求标准化，作为RegExp对象的静态方法[RegExp.escape()][2]，放入ES7。2015年7月31日，TC39认为，这个方法有安全风险，又不愿这个方法变得过于复杂，没有同意将其列入ES7，但这不失为一个真实的需求。
...
目前，有一个[提案][3]，在ES7加入后行断言。V8引擎4.9版已经支持，Chrome浏览器49版打开”experimental JavaScript features“开关（地址栏键入about:flags），就可以使用这项功能。
...
[1]: https://esdiscuss.org/topic/regexp-escape
[2]: https://github.com/benjamingr/RegExp.escape
[3]: https://github.com/goyakin/es-regexp-lookbehind
